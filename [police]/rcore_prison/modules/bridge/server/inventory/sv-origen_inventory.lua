    ...
    if Config.Inventories == Inventories.ORIGEN then
        ...
        Inventory.getInventoryItems = function(playerId)
            ...
            if doesExportExistInResource(Inventories.ORIGEN, "GetInventory") then
                items = exports[Inventories.ORIGEN]:GetInventory(playerId)
            elseif doesExportExistInResource(Inventories.ORIGEN, "getItems") then
                items = exports[Inventories.ORIGEN]:getItems(playerId)
            end
        ...
        Inventory.removeItem = function(client, item, amount, data)
            ...
            if doesExportExistInResource(Inventories.ORIGEN, "RemoveItem") then
                state = exports[Inventories.ORIGEN]:RemoveItem(client, item, amount, nil, true)
            elseif doesExportExistInResource(Inventories.ORIGEN, "removeItem") then
                state = exports[Inventories.ORIGEN]:removeItem(client, item, amount) 
            end
        ...
        Inventory.addItem = function(client, item, amount, data)
            ...
            if doesExportExistInResource(Inventories.ORIGEN, "addItem") then
                state = exports[Inventories.ORIGEN]:addItem(client, item, amount, data) 
            elseif doesExportExistInResource(Inventories.ORIGEN, "AddItem") then
                state = exports[Inventories.ORIGEN]:AddItem(client, item, amount, nil, data, true)
            end
