...
function AddEmoteMenu(menu)
    ...
    local whitemenu6to = _menuPool:AddSubMenu(submenu, Config.Languages[lang]['whitecustom6to'], "", "", Menuthing, Menuthing)
    table.insert(EmoteTable, Config.Languages[lang]['whitecustom6to'])
    ...
    for a, b in pairsByKeys(RP.White6to) do
        x, y, z = table.unpack(b)
        emoteitem = NativeUI.CreateItem(z, "/e (" .. a .. ")")
        whitemenu6to:AddItem(emoteitem)
