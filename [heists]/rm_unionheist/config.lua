...
Config['UnionHeist'] = {
    ...
    ['rewardItems'] = { -- Add this items to database or shared. Don't change the order, you can change the item names.
        {itemName = 'hardeneddecrypter', count = function() return 1 end, sellPrice = 0},
        {itemName = 'hardeneddrill', count = function() return 1 end, sellPrice = 0},
        {itemName = 'laptop_red', count = function() return 1 end, sellPrice = 0},
        {itemName = 'disruptor', count = function() return 1 end, sellPrice = 0},
    },
    ['rewardMoneys'] = {
        ['trollys'] = function()
