if isBridgeLoaded('Inventory', Inventory.PS) then
    ...
    AssetDeployer:registerCopyFilesDeploy('items-images', Inventory.PS, 'assets/inventory_images', 'html/images',
        function(data)
            local files = {}
    ...
    AssetDeployer:registerFileDeploy('exports', Inventory.PS, 'server/main.lua', function(file, data)
        file = append(file, ASSET_DEPLOYER_WATERMARK_PREFIX)
