Config = {
	...
	Inventory = {QB = false, OX = false, Other = true}, -- Set QB to true if you use an inventory that uses QB functionality Otherwise use OX if you have that or Other and add compat to your own inventory in server\custominventory.lua.
