Config = {
	Precision = 10000.0,
	DefaultHandlingClass = "CHandlingData",
	Fields = {
	...
	HeliFields = {
		{ name = "fThrust", type = "float", handlingClass = "CFlyingHandlingData", description = "Main rotor thrust" },
		{ name = "fThrustFallOff", type = "float", handlingClass = "CFlyingHandlingData", description = "Thrust falloff at speed" },
		{ name = "fYawMult", type = "float", handlingClass = "CFlyingHandlingData", description = "Yaw power" },
		{ name = "fYawStabilise", type = "float", handlingClass = "CFlyingHandlingData", description = "Yaw stability" },
		{ name = "fPitchMult", type = "float", handlingClass = "CFlyingHandlingData", description = "Pitch power" },
		{ name = "fRollMult", type = "float", handlingClass = "CFlyingHandlingData", description = "Roll power" },
		{ name = "fFormLiftMult", type = "float", handlingClass = "CFlyingHandlingData", description = "Form lift" },
		{ name = "fAttackLiftMult", type = "float", handlingClass = "CFlyingHandlingData", description = "Lift during attack/pitch" },
		{ name = "fMoveRes", type = "float", handlingClass = "CFlyingHandlingData", description = "Movement resistance" },
		{ name = "fTurnRes", type = "float", handlingClass = "CFlyingHandlingData", description = "Turn resistance (banking brake)" },
		{ name = "fThrustVectoring", type = "float", handlingClass = "CFlyingHandlingData", description = "Decides how much of the thrust can tilt to follow the nose" },
		{ name = "fAttackDiveMult", type = "float", handlingClass = "CFlyingHandlingData", description = "how much extra thrust/force do I get when I pitch the nose down" }
	},
	Types = {
		["float"] = {
