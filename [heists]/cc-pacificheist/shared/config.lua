...
Config.Inventory = "custom" -- qb / lj / ox / ps / custom (Add custom in server/open.lua)
...
Config.UseCCPowerPlant = true -- Use the built in powerplant? If false, powerplant still needs to be hit, the script will just check if there is a active blackout.
