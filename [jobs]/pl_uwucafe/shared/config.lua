...
Config.Shop = {
    Storage = {
		...
		items = {
            Drinks = {
                { name= "cc_black_tapioca_pearls", label= "Black Tapioca Pearls", price =50, amount = 99999999},
                { name = "cc_brewed_black_tea", label="Brewed Black Tea", price = 50, amount = 99999999},
                { name = "cc_mixedberries", label="Mixed Berries",price = 50,amount = 99999999},
                { name = "cc_milk", label="Milk", price = 50, amount = 99999999},
                { name = "cc_sugar", label="Sugar", price = 50, amount = 99999999},
                { name = "cc_vanilla_icecream", label="Vanilla Icecream", price = 50, amount = 99999999},
                { name = "cc_chocolate_syrup", label="Chocolate Syrup ", price = 50, amount = 99999999},
                { name = "cc_strawberries", label="Strawberries", price = 50, amount = 99999999},
                { name = "cc_ripebanana", label="Ripe Banana", price = 50, amount = 99999999},
                { name = "cc_yogurtcup", label="Yogurt Cup", price = 50, amount = 99999999},
                { name = "cc_cuporangejuice", label="Cup of Orange Juice", price = 50, amount = 99999999},
                { name = "cc_pineapple_chunks", label="Pineapple Chunks", price = 50, amount = 99999999},
                { name = "cc_mango_chunks", label="Mango Chunks", price = 50, amount = 99999999},  
                { name = "cc_coconut_milk", label="Coconut Milk", price = 50, amount = 99999999},
                { name = "cc_emptycup", label="Empty Cup", price = 50, amount = 99999999},  
                { name = "cc_waterbottle", label="Water Bottle", price = 50, amount = 99999999},  
            },
            Ramen = {
                {name = "cc_wheat_noodles",label="Wheat Noodles", price = 50, amount = 99999999},
                { name = "cc_green_onions", label="Green Onions", price = 50, amount = 99999999},
                { name = "cc_chashu_pork", label="Chashu Pork", price = 50, amount = 99999999},
                { name = "cc_miso_broth", label="Miso Broth", price = 50, amount = 99999999},
                { name = "cc_butter", label="Butter", price = 50, amount = 99999999},
                { name = "cc_spinach", label="Spinach", price = 50, amount = 99999999},
                { name = "cc_soft_boiled_egg", label="Soft Boiled Egg", price = 50, amount = 99999999},
            },
            Coffee = {
                { name = "cc_milk",label="Milk", price = 50, amount = 99999999},
                { name = "cc_sugar", label="Sugar", price = 50, amount = 99999999},
                { name = "cc_chocolate_syrup", label="Chocolate Syrup", price = 50, amount = 99999999},
                { name = "cc_cocao_powder", label="Cocoa Powder", price = 50, amount = 99999999},
            },
            Icecream = {
                { name = 'cc_milk',label="Milk", price = 50, amount = 99999999},
                { name = "cc_heavy_cream", label="Heavy Cream", price = 50, amount = 99999999},
                { name = "cc_pure_vanilla", label="Pure Vanilla", price = 50, amount = 99999999},
                { name = "cc_chocolate_cookies", label="Chocolate Cookies", price = 50, amount = 99999999},
                { name = "cc_chocolate_chips", label="Chocolate Chips", price = 50, amount = 99999999},
                { name = "cc_strawberries", label="Strawberries", price = 50, amount = 99999999},
                { name = "cc_coffee_powder", label="Coffee Powder", price = 50, amount = 99999999},
            },
            Sandwich = {
                {name = 'cc_bacon_strips',label="Bacon Strips", price = 5, amount = 99999999},
                {name = 'cc_slices_of_bread',label="Slices of Bread", price = 5, amount = 99999999},
                {name = 'cc_lettuce',label="Lettuce", price = 5, amount = 99999999},
                {name = 'cc_butter',label="Butter", price = 5, amount = 99999999},
                {name = 'cc_turkey_slices',label="Turkey Slices", price = 5, amount = 99999999},
                {name = 'cc_mozzarella_cheese',label="Mozzarella Cheese", price = 5, amount = 99999999},
                {name = 'cc_avocado',label="Avocado", price = 5, amount = 99999999},
                {name = 'cc_cheddar_cheese',label="Cheddar Cheese", price = 5, amount = 99999999},
            },
        }
	},
}
