...
-- Density values
Config.HighDensity = 0.75  -- Density when few players (1-10 players)
Config.LowDensity = 0.25   -- Density when many players (100+ players)

-- Update interval (milliseconds) - How often to check player count and update density
Config.UpdateInterval = 5000    -- Check every 5 seconds
