...
Framework.OnReady(Framework, function()
    Framework.Items = {}
    -- Get items from qbx_core shared items (same as qbx_core does)
    CreateThread(function()
        local items = nil
        while not items do
            Wait(100)
            -- Try to get items from qbx_core shared
            if QBX and QBX.Shared and QBX.Shared.Items then
                items = QBX.Shared.Items
            end
        end
