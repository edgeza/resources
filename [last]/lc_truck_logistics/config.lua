...
Config.trucker_locations = {
	["trucker_1"] = {															-- ID
		...
		['trailer_location'] = {												-- Trailer coordinates, where the trailers will spawn (vector4)
			...
			{1269.84,-3215.16,5.91,90.00},
			{1269.25,-3221.81,5.91,90.00},
			{1269.18,-3227.86,5.91,90.00},
			{1269.27,-3234.87,5.91,90.00},
		},
...
Config.jobs = {
	...
	['price_per_km_min'] = 500,				    -- Minimum price per kilometer of the contract ($520)
	['price_per_km_max'] = 1050,				-- Maximum price per kilometer of the contract ($1050)
	...
	['probability_urgent_cargo'] = 30,			-- The urgent load is generated randomly, here you can configure the probability (%)
	...
	['available_loads'] = {
		...
		-- Special high-level cargo types (Level 35+)
		{ trailer = "armytanker", name = "Transport of rare earth metals", def = {0,1,1}, min_level = 35, special = "premium"},
		{ trailer = "armytanker", name = "Transport of quantum materials", def = {0,1,1}, min_level = 40, special = "premium"},
		{ trailer = "armytanker", name = "Transport of alien artifacts", def = {0,1,1}, min_level = 45, special = "legendary"},
		{ trailer = "armytanker", name = "Transport of time crystals", def = {0,1,1}, min_level = 50, special = "mythic"},
		
		-- Special high-level cargo types (Level 40+)
		{ trailer = "docktrailer", name = "Transport of classified documents", def = {0,1,1}, min_level = 40, special = "premium"},
		{ trailer = "docktrailer", name = "Transport of experimental technology", def = {0,1,1}, min_level = 45, special = "legendary"},
		{ trailer = "docktrailer", name = "Transport of interdimensional cargo", def = {0,1,1}, min_level = 50, special = "mythic"},
		
		-- Special high-level cargo types (Level 45+)
		{ trailer = "tvtrailer", name = "Transport of reality-bending artifacts", def = {0,1,1}, min_level = 45, special = "legendary"},
		{ trailer = "tvtrailer", name = "Transport of cosmic energy", def = {0,1,1}, min_level = 50, special = "mythic"},
		
		-- Special high-level cargo types (Level 50+)
		{ trailer = "trailerlogs", name = "Transport of ancient wisdom", def = {0,1,1}, min_level = 50, special = "mythic"},
		{ trailer = "trailers", name = "Transport of forbidden knowledge", def = {0,1,1}, min_level = 50, special = "mythic"},
	},
}
...
Config.drivers = {
	...
	['hiring_costs'] = {						-- Cost of hiring the driver (this amount will only be paid at the time of hiring)
		['min'] = 2000,							-- This is the minimum base cost of hiring the employee
		['max'] = 4000,							-- This is the maximum base cost of hiring the employee (this amount will increase according to the employee's skills)
		['percentage_skills'] = 20,				-- This is the % cost that each skill will add to the cost of hiring the driver. That is, for each skill level the driver has, this percentage will increase. (In this case, each skill will increase the cost by 25%)
	},
	...
	['max_drivers_per_player'] = {				-- Maximum number of drivers the player can hire per level
        [0] = 2,								-- Between level 0  to 10 player will be able to hire 2 driver
        [1] = 2,
        [2] = 2,
        [3] = 2,
        [4] = 2,
...
Config.driver_jobs = {
	...
	['profit'] = {								-- These are the drivers' earnings for each contract, a random value is generated for each contract
		['min'] = 400,							-- Minimum base profit, this will be the minimum money this driver can generate
		['max'] = 600,							-- Maximum base profit, this will be the maximum amount of money this driver can generate (this amount will increase according to the driver's skills)
		['percentage_skills'] = 20,				-- This is the % value that each skill will add to the driver's final profit. That is, the more skills he has, the greater the profit.
	},
	['fuel_consumption'] = {					-- Fuel consumption for each delivery
		['min'] = 2,							-- Minimum % amount consumed
		['max'] = 7								-- Maximum % amount consumed
	},
...
Config.sell_price_multiplier = 0.8				-- Value you receive when selling the used truck
Config.dealership = {							-- Truck dealership vehicles
	...
	['phantom4'] = {
		['name'] = 'JoBuilt Phantom Elite',
		['price'] = 250000,
		['engine'] = "18.0L Quad-Turbo V16",
		['transmission'] = "14-Speed Elite",
		['hp'] = '750',
		['img'] = 'img/trucks/phantom3.png',
		['driver_bonus'] = 45,
		['required_level'] = 35
	...
	['hauler2'] = {
		['name'] = 'JoBuilt Hauler Pro',
		['price'] = 350000,
		['engine'] = "20.0L Twin-Turbo V12",
		['transmission'] = "16-Speed Pro",
		['hp'] = '850',
		['img'] = 'img/trucks/JoBuilt_Hauler_Pro.png',
		['driver_bonus'] = 60,
		['required_level'] = 40
	},
	['hauler2'] = {
		['name'] = 'JoBuilt Phantom Legend',
		['price'] = 450000,
		['engine'] = "25.0L Quad-Turbo V16",
		['transmission'] = "18-Speed Elite",
		['hp'] = '950',
		['img'] = 'img/trucks/jobuilt_legend.png',
		['driver_bonus'] = 80,
		['required_level'] = 45
	},
	['v8truck'] = {
		['name'] = 'Performance Truck V8',
		['price'] = 600000,
		['engine'] = "30.0L Octa-Turbo V20",
		['transmission'] = "20-Speed Legend",
		['hp'] = '1200',
		['img'] = 'img/trucks/jobuilt_v8.png',
		['driver_bonus'] = 100,
		['required_level'] = 50
	},
	-- ['hauler99'] = {
	...
	-- 	['img'] = 'img/trucks/vetirs.png',
	-- 	['driver_bonus'] = 2,
	-- 	['required_level'] = 9999999999
	-- },
	-- ['PRIME'] = {
	-- 	['name'] = 'Optimus Prime Truck',
	-- 	['price'] = 999999999,
	-- 	['engine'] = "14.5L Twin-Turbo V8",
	-- 	['transmission'] = "5-Speed",
	-- 	['hp'] = '380',
	-- 	['img'] = 'img/trucks/Vinnie_Russo_PRIME.png',
	-- 	['driver_bonus'] = 2,
	-- 	['required_level'] = 9999999999
	-- },
	-- ['ImperialGold'] = {
	-- 	['name'] = 'Peterbilt 389 Imperial Gold',
	-- 	['price'] = 999999999,
	-- 	['engine'] = "12.0L Twin-Turbo V6",
	-- 	['transmission'] = "5-Speed",
	-- 	['hp'] = '380',
	-- 	['img'] = 'img/trucks/Vinnie_Russo_ImperialGold.png',
	-- 	['driver_bonus'] = 2,
	-- 	['required_level'] = 9999999999
	-- }
}
...
Config.loans = {
	...
	['plans'] = {
		{
			['loan_amount'] = 5000,		-- Total loan amount (5,000)
...
--[[
	...
	Level 50 represents the maximum skill level attainable.
]]
...
--[[
	...
	Level 50 represents the maximum achievable level.
]]
...
Config.party = {
	['price_to_create'] = 1000,		-- Price to create a party
	['price_per_member'] = 100, 	-- Cost of each additional member
	['max_members'] = 10,			-- Maximum number of members of each group
	['party_money_bonus'] = 20,		-- Bonus money (in %) that each party member receives upon completing a delivery
	['party_exp_bonus'] = 20,		-- Bonus xp (in %) that each party member receives when completing a delivery
	['only_leader_can_start'] = false, -- true: Only the group leader can start a delivery | false: Any member can start a delivery
	['level_bonus'] = {				-- Additional bonuses for higher-level party leaders
		[40] = { money = 30, exp = 30 },		-- Level 40+ leaders get +30% bonus
		[45] = { money = 40, exp = 40 },	-- Level 45+ leaders get +40% bonus
		[50] = { money = 50, exp = 50 }	-- Level 50+ leaders get +50% bonus
	}
}
...
Config.prestige = {
	['enabled'] = true,				-- Enable prestige system
	['min_level'] = 50,				-- Minimum level required to prestige
	['cost'] = 1000000,				-- Cost to prestige (1 million)
	['bonus_per_prestige'] = 5,		-- +5% bonus per prestige level
	['max_prestige'] = 10,			-- Maximum prestige level
	['keep_trucks'] = true,			-- Keep trucks after prestige
	['keep_drivers'] = true,		-- Keep drivers after prestige
	['reset_level'] = 0,			-- Reset to level 0 after prestige
	['reset_exp'] = true			-- Reset experience after prestige
}

-- Special cargo types for high-level players
Config.special_cargo = {
	['enabled'] = true,				-- Enable special cargo types
	['min_level'] = 35,				-- Minimum level to see special cargo
	['types'] = {
		['premium'] = {
			['min_level'] = 30,
			['money_multiplier'] = 2.5,
			['exp_multiplier'] = 2.0,
			['rarity'] = 15			-- 15% chance to appear
		},
		['legendary'] = {
			['min_level'] = 35,
			['money_multiplier'] = 4.0,
			['exp_multiplier'] = 3.0,
			['rarity'] = 8			-- 8% chance to appear
		},
		['mythic'] = {
			['min_level'] = 40,
			['money_multiplier'] = 6.0,
			['exp_multiplier'] = 4.0,
			['rarity'] = 3			-- 3% chance to appear
		}
	}
}

-- Skill tree system for high-level players
Config.skill_tree = {
	['enabled'] = true,				-- Enable skill tree system
	['min_level'] = 30,				-- Minimum level to access skill tree
	['skill_points_per_level'] = 1,	-- Skill points gained per level
	['max_skill_points'] = 50,		-- Maximum skill points that can be stored
	
	['skills'] = {
		['fuel_efficiency'] = {
			['name'] = 'Fuel Efficiency',
			['description'] = 'Reduce fuel consumption by 2% per level',
			['max_level'] = 10,
			['cost_per_level'] = 1,
			['effect_per_level'] = 2	-- 2% reduction per level
		},
		['repair_mastery'] = {
			['name'] = 'Repair Mastery',
			['description'] = 'Reduce repair costs by 3% per level',
			['max_level'] = 10,
			['cost_per_level'] = 1,
			['effect_per_level'] = 3	-- 3% reduction per level
		},
		['cargo_expertise'] = {
			['name'] = 'Cargo Expertise',
			['description'] = 'Increase cargo value by 1% per level',
			['max_level'] = 15,
			['cost_per_level'] = 2,
			['effect_per_level'] = 1	-- 1% increase per level
		},
		['route_optimization'] = {
			['name'] = 'Route Optimization',
			['description'] = 'Reduce delivery time by 1% per level',
			['max_level'] = 15,
			['cost_per_level'] = 2,
			['effect_per_level'] = 1	-- 1% reduction per level
		},
		['driver_motivation'] = {
			['name'] = 'Driver Motivation',
			['description'] = 'Increase driver efficiency by 2% per level',
			['max_level'] = 10,
			['cost_per_level'] = 3,
			['effect_per_level'] = 2	-- 2% increase per level
		},
		['prestige_mastery'] = {
			['name'] = 'Prestige Mastery',
			['description'] = 'Increase prestige bonuses by 1% per level',
			['max_level'] = 5,
			['cost_per_level'] = 5,
			['effect_per_level'] = 1,	-- 1% increase per level
			['requires_prestige'] = 1	-- Requires at least 1 prestige
		}
	}
}

-- Special abilities for high-level players
Config.special_abilities = {
	['enabled'] = true,				-- Enable special abilities
	['abilities'] = {
		['teleport_garage'] = {
			['name'] = 'Garage Teleport',
			['description'] = 'Teleport to any owned garage',
			['min_level'] = 40,
			['cooldown'] = 3600,		-- 1 hour cooldown
			['cost'] = 5000			-- Cost to use ability
		},
		['emergency_repair'] = {
			['name'] = 'Emergency Repair',
			['description'] = 'Instantly repair vehicle to 100%',
			['min_level'] = 45,
			['cooldown'] = 7200,		-- 2 hour cooldown
			['cost'] = 10000			-- Cost to use ability
		},
		['cargo_insurance'] = {
			['name'] = 'Cargo Insurance',
			['description'] = 'Protect cargo from damage for 1 hour',
			['min_level'] = 50,
			['cooldown'] = 14400,		-- 4 hour cooldown
			['cost'] = 25000			-- Cost to use ability
		}
	}
}

-- Level-based contract generation
Config.level_based_contracts = {
	['enabled'] = true,				-- Enable level-based contract generation
	['tiers'] = {
		['beginner'] = {				-- Levels 0-19
			['min_level'] = 0,
			['max_level'] = 19,
			['contract_multiplier'] = 1.0,
			['max_distance'] = 15,
			['special_cargo_chance'] = 0
		},
		['intermediate'] = {			-- Levels 20-34
			['min_level'] = 20,
			['max_level'] = 34,
			['contract_multiplier'] = 1.2,
			['max_distance'] = 25,
			['special_cargo_chance'] = 5
		},
		['advanced'] = {				-- Levels 35-44
			['min_level'] = 30,
			['max_level'] = 34,
			['contract_multiplier'] = 1.5,
			['max_distance'] = 35,
			['special_cargo_chance'] = 15
		},
		['expert'] = {					-- Levels 45-49
			['min_level'] = 35,
			['max_level'] = 39,
		...
		['master'] = {					-- Level 50+
			...
			['max_distance'] = 99,
			['special_cargo_chance'] = 40
		}
	}
}

-- Special events for high-level players
Config.special_events = {
	['enabled'] = true,				-- Enable special events
	['events'] = {
		['cargo_rush'] = {
			['name'] = 'Cargo Rush',
			['description'] = 'Increased cargo value and experience for 2 hours',
			['min_level'] = 30,
		...
		['driver_training'] = {
			...
			['description'] = 'All drivers gain 1 skill level',
			['min_level'] = 35,
		...
		['prestige_boost'] = {
			['name'] = 'Prestige Boost',
			['description'] = 'Double prestige bonuses for 1 hour',
			['min_level'] = 40,
