...
Config = {
    ...
    HQS = {
        ...
        ["disciples"] = {
             MapPosition = {
                vec2(-1589.15, 5149.5),
                vec2(-1619.42, 5135.78),
                vec2(-1619.7, 5122.66),
                vec2(-1686.92, 5110.41),
                vec2(-1758.41, 5114.12),
                vec2(-1779.59, 5170.09),
                vec2(-1771.94, 5250.97),
                vec2(-1664.18, 5266.8),
                vec2(-1634.34, 5241.63),
                vec2(-1628.68, 5209.0),
                vec2(-1622.88, 5204.55),
                vec2(-1613.69, 5180.49),
                vec2(-1586.97, 5173.42),
                vector2(-82.95, 849.48),
            },
            
            MiddlePoint = vec3(-1709.07, 5185.15, 6.27),
            HQCanBeCaptured = false,
    ...
    Graffiti = {
        ...
        Icons = {
            ...
            {name = "Los Dorados", prop = "sprays_vagos", png = "Vagos.png"},
            {name = "Lost MC", prop = "sprays_lost", png = "Lost_MC.png"},
            {name = "Ballas", prop = "sprays_ballas", png = "Ballas.png"},
            {name = "AOD", prop = "sprays_aod", png = "AOD_logo.png"},
            {name = "Omerta", prop = "sprays_omerta", png = "MafiaWhite.png"},
            {name = "San Diablo Syndicates", prop = "sprays_sandiablo", png = "CartelLogo.png"},
            {name = "Harbingers", prop = "sprays_sandiablo", png = ""},
            {name = "Kurohana Clan", prop = "sprays_sandiablo", png = "Yakuza.png"},
