...
// PUBLIC VALUES
const FiveMServerName = "OneLife Roleplay";
const DiscordInviteLink = "https://discord.gg/X9kEKF5bAD";
const FiveMServerIP = "129.232.147.26";
...
// DISCORD BOT
const DiscordBotToken = "MTMzNDEzMTUxMzkzOTIwMjExOQ.GQqLgh.IPhDIiJuNn3FIMEXwsbuJjXNI5vuvXlAcUOvxk";
const DiscordGuildId = "1332319766215397396";
...
const DiscordWhitelistRoleIds = "1332978636784926720";

// SLASH COMMANDS / DISCORD PERMISSIONS
const EnableDiscordSlashCommands = true;
const DiscordModRoleId = "000000000000000000"; //"1332337655802757152";
const DiscordAdminRoleId = "1332337622273622017";
const DiscordGodRoleId = "1332337571245723721";
