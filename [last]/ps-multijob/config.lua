...
Config.Descriptions = {
	...
	["bennies"] = "Fix the bullet holes",
	["6str"] = "Fix the bullet holes",
	["olrpmechanic"] = "Fix the bullet holes",
	["palmcoast"] = "Fix the bullet holes",
	["towing"] = "Pickup the tow truck and steal some vehicles",
