...
Config.Peds = {
    ...
    {name = 'jeweller_ped', coords = vector4(-630.48, -240.63, 38.15), model = 's_f_y_shop_mid', scenario = 'WORLD_HUMAN_CLIPBOARD', label = 'Speak to Jeweller', icon = 'fa-solid fa-gem', event = 'boii-mining:cl:JewelleryMenu', distance = 2.0, useped = true},
