local Translations = {
    notify = {
        ...
        powerplant_hit = "The powerplant has already been hit.",
        power_company = "LS Water & Power",
        power_restored = "The power has been restored!",
        power_outage = "A power outage has been detected. We're working on it!"
    },
    target = {
