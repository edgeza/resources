...
Config.Peds = { -- Default coords (You can find petshop from https://forum.cfx.re/t/release-sandy-pet-shop-mlo/2172530)
    ['petshop'] = {
        ...
        coords = vector3(562.3, 2741.2, 42.8),
        heading = 184.1
    },
    ['petstore'] = {
        ped = 'a_f_y_golfer_01',
        ...
        coords = vector3(566.4, 2741.2, 42.2),
        heading = 184.1
    },
}
...
-- COMMANDS / KEYBINDS
Config.EnableKeybinds = 'ox' -- 'ox' / 'default' / false -- default [not recommended] will create keymap, its permanent for that key | ox [recommended] create a temporary keybind for that key | false to disable keybind
Config.Keybinds = {
    ["emotemenu"] = {
        command = "petemote",
        key = "J",
