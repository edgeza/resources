...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', HandlePlayerLoaded)
RegisterNetEvent('QBX:Client:OnPlayerLoaded', HandlePlayerLoaded)
...
RegisterNetEvent('QBX:Client:OnPlayerUnload', HandlePlayerUnload)

-- Handles state when PlayerData is changed. We're just looking for inventory updates.
local function HandleSetPlayerData(val)
    PlayerData = val
    DoRadioCheck(PlayerData.items)
end

RegisterNetEvent('QBCore:Player:SetPlayerData', HandleSetPlayerData)
RegisterNetEvent('QBX:Player:SetPlayerData', HandleSetPlayerData)
