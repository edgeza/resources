Config = {
    ...
    Prisoners = {
        Companion = false,               -- Disabled: prevents forcing police to ignore player globally
    ...
    JailByNPCSettings = {
        ...
        JailTime = 30,       -- This is the jail time for NPC jail (default in min)
    ...
    Escape = {
        ...
        Enable = false,                                    -- This is used for enabling prison break system
        ...
        NotifyJobs = { 'police', 'bcso' },                 -- This is the list of the jobs which are going to be notified when prisoner is escaping using supported dispatch system
    ...
    Menu = {
        Position = 'top-left', -- This is the position of the menu ['top-left', 'top-right', 'bottom-left', 'bottom-right']
    },
    ...
    Jobs = {
        ...
        ['bcso'] = true, -- This is the job which is allowed to jail/unjail players
    },
    ...
    Alcatraz = {
        ...
        Visit = {
            Enable = false,                                    -- Should allow to teleport to Visitation center & spawn NPC
    ...
    Canteen = {
        ...
        CreditItems = {
            { name = 'water_bottle',     price = 30, label = 'Water' },
        ...
        FreeFoodPackageItems = {
            { name = 'water_bottle',  count = 1, label = 'Water' },
    ...
    Stash = {
        ...
        KeepItems = {
            ...
            ['water_bottle'] = true,
            ['sludgie'] = true,
            ['money'] = false, -- Doesnt work with qs-inventory
            ['cash'] = false,  -- Doesnt work with qs-inventory
        }
    },
    ...
    CigarProduction = {
        RewardCooldown = 0.01,       -- This is the reward cooldown for minigame (min)
    ...
    Minigame = {
        ...
        MoveStep = 0.05,                                         -- Speed of arrowKeys generation block (> 0.02!!)
