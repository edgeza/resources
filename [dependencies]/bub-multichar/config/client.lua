return {
  loadingModelsTimeout = 40000, -- Waiting time for ox_lib to load the models before throws an error, for low specs pc
  defaultAllowedCharacters = 1, -- The amount of characters you can have in total
