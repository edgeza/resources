...
CreateThread(function()
    if Config.Inventories == Inventories.TGIANN then
        ...
        Inventory.addItem = function(client, item, amount, data)
            ...
            exports[Inventories.TGIANN]:AddItem(client, item, amount, nil, data, false)
        ...
        Inventory.getInventoryItems = function(playerId)
            ...
            if doesExportExistInResource(Inventories.TGIANN, "GetPlayerItems") then
                inventory = exports[Inventories.TGIANN]:GetPlayerItems(playerId)
            end
        ...
        Inventory.clearInventory = function(client)
            local state, error_message = pcall(function()
                return exports[Inventories.TGIANN]:ClearInventory(client)
            end)
        ...
        Inventory.removeItem = function(client, item, amount, data)
            ...
            return exports[Inventories.TGIANN]:RemoveItem(client, item, amount, nil)
        end
