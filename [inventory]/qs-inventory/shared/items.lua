...
ItemList = {
    ...
    respray_kit                     = { name = 'respray_kit', label = 'Respray Kit', weight = 1000, type = 'item', image = 'respray_kit.png', unique = false, useable = true, shouldClose = false, combinable = true, description = nil },
    ...
    weapon_patchday8ng                 = { name = 'weapon_patchday8ng', label = 'Patchday8ng Carbine Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_PATCHDAY8NG.png', unique = true, useable = false, description = 'Patchday8ng carbine rifle skin' },
    ...
    weapon_blue_carbine_rifle           = { name = 'weapon_blue_carbine_rifle', label = 'Blue Carbine Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_BLUE_CARBINE_RIFLE.png', unique = true, useable = false, description = 'Blue themed carbine rifle skin' },
    weapon_ultra_blackout_rifle         = { name = 'weapon_ultra_blackout_rifle', label = 'Ultra Blackout Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_ULTRA_BLACKOUT_RIFLE.png', unique = true, useable = false, description = 'Ultra blackout carbine rifle skin' },
    weapon_lime_black_ar                = { name = 'weapon_lime_black_ar', label = 'Lime Green And Black AR', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_LIME_BLACK_AR.png', unique = true, useable = false, description = 'Lime green and black AR skin' },
    weapon_no_silver_rifle              = { name = 'weapon_no_silver_rifle', label = 'No Silver Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_NO_SILVER_RIFLE.png', unique = true, useable = false, description = 'No silver carbine rifle skin' },
    weapon_white_black_ar               = { name = 'weapon_white_black_ar', label = 'White And Black AR', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_WHITE_BLACK_AR.png', unique = true, useable = false, description = 'White and black AR skin' },
    weapon_white_orange_rifle           = { name = 'weapon_white_orange_rifle', label = 'White And Orange Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_WHITE_ORANGE_RIFLE.png', unique = true, useable = false, description = 'White and orange carbine rifle skin' },
    -- Glock Pack Skins
    weapon_candy_apple_glock            = { name = 'weapon_candy_apple_glock', label = 'Candy Apple Glock', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_CANDY_APPLE_GLOCK.png', unique = true, useable = false, description = 'Candy apple glock skin' },
    weapon_catacombs_glock              = { name = 'weapon_catacombs_glock', label = 'Catacombs Beta Glock', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_CATACOMBS_GLOCK.png', unique = true, useable = false, description = 'Catacombs beta glock skin' },
    weapon_freedom_glock                = { name = 'weapon_freedom_glock', label = 'Freedom Glock', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_FREEDOM_GLOCK.png', unique = true, useable = false, description = 'Freedom glock skin' },
    weapon_hornet_glock                 = { name = 'weapon_hornet_glock', label = 'Hornet Glock', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_HORNET_GLOCK.png', unique = true, useable = false, description = 'Hornet glock skin' },
    weapon_safari_glock                 = { name = 'weapon_safari_glock', label = 'Safari Glock', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_SAFARI_GLOCK.png', unique = true, useable = false, description = 'Safari glock skin' },
    -- Thermal Katana Skins
    weapon_cyan_thermal_katana          = { name = 'weapon_cyan_thermal_katana', label = 'Cyan Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_CYAN_THERMAL_KATANA.png', unique = true, useable = false, description = 'Cyan thermal katana skin' },
    weapon_lime_thermal_katana          = { name = 'weapon_lime_thermal_katana', label = 'Lime Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_LIME_THERMAL_KATANA.png', unique = true, useable = false, description = 'Lime thermal katana skin' },
    weapon_pink_thermal_katana          = { name = 'weapon_pink_thermal_katana', label = 'Pink Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_PINK_THERMAL_KATANA.png', unique = true, useable = false, description = 'Pink thermal katana skin' },
    weapon_purple_thermal_katana        = { name = 'weapon_purple_thermal_katana', label = 'Purple Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_PURPLE_THERMAL_KATANA.png', unique = true, useable = false, description = 'Purple thermal katana skin' },
    weapon_red_thermal_katana           = { name = 'weapon_red_thermal_katana', label = 'Red Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_RED_THERMAL_KATANA.png', unique = true, useable = false, description = 'Red thermal katana skin' },
    weapon_white_thermal_katana         = { name = 'weapon_white_thermal_katana', label = 'White Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_WHITE_THERMAL_KATANA.png', unique = true, useable = false, description = 'White thermal katana skin' },
    weapon_yellow_thermal_katana        = { name = 'weapon_yellow_thermal_katana', label = 'Yellow Thermal Katana', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_YELLOW_THERMAL_KATANA.png', unique = true, useable = false, description = 'Yellow thermal katana skin' },
    -- Individual Weapon Skins
    weapon_bombinglr300                 = { name = 'weapon_bombinglr300', label = 'Bombing LR300', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_BOMBINGLR300.png', unique = true, useable = false, description = 'Bombing LR300 carbine rifle skin' },
    weapon_families_glock_18c           = { name = 'weapon_families_glock_18c', label = 'Families Glock 18C', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_FAMILIES_GLOCK_18C.png', unique = true, useable = false, description = 'Families glock 18C skin' },
    weapon_hypebeast                    = { name = 'weapon_hypebeast', label = 'Hypebeast Carbine Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_HYPEBEAST.png', unique = true, useable = false, description = 'Hypebeast carbine rifle skin' },
    weapon_paint_splatter               = { name = 'weapon_paint_splatter', label = 'Paint Splatter Rifle', weight = 3500, type = 'weapon', ammotype = 'AMMO_RIFLE', image = 'WEAPON_PAINT_SPLATTER.png', unique = true, useable = false, description = 'Paint splatter carbine rifle skin' },
    weapon_pi_revolver                  = { name = 'weapon_pi_revolver', label = 'PI Revolver', weight = 1200, type = 'weapon', ammotype = 'AMMO_PISTOL', image = 'WEAPON_PI_REVOLVER.png', unique = true, useable = false, description = 'PI revolver skin' },
    weapon_reaper_machete               = { name = 'weapon_reaper_machete', label = 'Reaper Machete', weight = 1200, type = 'weapon', ammotype = nil, image = 'WEAPON_REAPER_MACHETE.png', unique = true, useable = false, description = 'Reaper machete skin' },
    ...
    ['weapon_m4a1dragon']              = {
        ...
        ['type'] = 'weapon',
        ['ammotype'] = 'AMMO_RIFLE',
        ['image'] = 'weapon_m4a1dragon.png',
        ['unique'] = true,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = 'Dragon themed M4A1 assault rifle'
    },
    ['weapon_sabresword']              = {
        ...
        ['type'] = 'weapon',
        ['ammotype'] = nil,
        ['image'] = 'weapon_sabresword.png',
        ['unique'] = true,
        ['useable'] = false,
        ['shouldClose'] = true,
        ['combinable'] = nil,
        ['description'] = 'Elegant sabre sword'
    },
    ['weapon_famas']                  = {
        ['name'] = 'weapon_famas',
        ['label'] = 'FAMAS',
...
['knife_case'] = {['name'] = 'knife_case', ['label'] = 'Knife Case', ['weight'] = 50, ['type'] = 'item', ['image'] = 'knife_case.png', ['unique'] = false, ['useable'] = true, ['shouldClose'] = true, ['combinable'] = nil, ['description'] = 'A case containing various rare and exclusive knives with different rarities'},
...
['weapon_bf_ultraviolet'] = {['name'] = 'weapon_bf_ultraviolet', ['label'] = 'Butterfly Ultra Violet', ['weight'] = 500, ['type'] = 'weapon', ['ammotype'] = nil, ['image'] = 'WEAPON_BF_ULTRAVIOLET.png', ['unique'] = true, ['useable'] = false, ['description'] = 'CS:GO Knife'},
['weapon_bf_urbanmasked'] = {['name'] = 'weapon_bf_urbanmasked', ['label'] = 'Butterfly Urban Masked', ['weight'] = 500, ['type'] = 'weapon', ['ammotype'] = nil, ['image'] = 'WEAPON_BF_URBANMASKED.png', ['unique'] = true, ['useable'] = false, ['description'] = 'CS:GO Knife'},
-- Missing Karambit variants (slaugther spelling correction)
['weapon_karambit_slaugther'] = {['name'] = 'weapon_karambit_slaugther', ['label'] = 'Karambit Slaugther', ['weight'] = 500, ['type'] = 'weapon', ['ammotype'] = nil, ['image'] = 'WEAPON_KARAMBIT_SLAUGTHER.png', ['unique'] = true, ['useable'] = false, ['description'] = 'CS:GO Knife'},
