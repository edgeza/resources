svConfig = {
    ...
    competitionNotificationWebHook = 'https://discord.com/api/webhooks/1267207541801357352/JLvylOgAcrGO4kDyM8x1ANzyaMvqu6ci9mqt9EQ94fqREqeOHSN8Pqj215o7hI16NvFU',

    -- The logo which will be attached to the competition Discord notification.
    competitionDiscordLogo = 'https://imgur.com/a/1WMixYf',
    ...
    maximumGeneratedCompetitions = 50,
    ...
    isTrackCreationRestricted = true,
    ...
    competitionCreationRequiredElo = 3000,
