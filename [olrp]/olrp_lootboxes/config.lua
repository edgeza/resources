...
CFG.CaseList = {
    ...
    ["knife_case"] = {
        ...
        items = {
            ...
            {name = "M9 Bayonet Boreal Forest", item = "weapon_m9_borealforest", amount = 1, rarity = "Uncommon", image = "WEAPON_M9_BOREALFOREST.png"},
            {name = "M9 Bayonet Night", item = "weapon_m9_night", amount = 1, rarity = "Uncommon", image = "WEAPON_M9_NIGHT.png"},
            ...
            {name = "Butterfly Black Laminate", item = "weapon_bf_blacklaminate", amount = 1, rarity = "Uncommon", image = "WEAPON_BF_BLACKLAMINATE.png"},
            ...
            {name = "Butterfly Autotronic", item = "weapon_bf_autotronic", amount = 1, rarity = "Rare", image = "WEAPON_BF_AUTOTRONIC.png"},
            ...
            {name = "Butterfly Free Hand", item = "weapon_bf_freehand", amount = 1, rarity = "Epic", image = "WEAPON_BF_FREEHAND.png"},
            ...
            {name = "Butterfly Marble Fade", item = "weapon_bf_marblefade", amount = 1, rarity = "Epic", image = "WEAPON_BF_MARBLEFADE.png"},
            {name = "Butterfly Fade", item = "weapon_bf_fade", amount = 1, rarity = "Epic", image = "WEAPON_BF_FADE.png"},
            {name = "Butterfly Lore", item = "weapon_bf_lore", amount = 1, rarity = "Epic", image = "WEAPON_BF_LORE.png"},
            {name = "Butterfly Gamma Doppler Phase 1", item = "weapon_bf_gdp1", amount = 1, rarity = "Epic", image = "WEAPON_BF_GDP1.png"},
            {name = "Butterfly Gamma Doppler Phase 2", item = "weapon_bf_gdp2", amount = 1, rarity = "Epic", image = "WEAPON_BF_GDP2.png"},
            {name = "Butterfly Gamma Doppler Phase 3", item = "weapon_bf_gdp3", amount = 1, rarity = "Epic", image = "WEAPON_BF_GDP3.png"},
            {name = "Butterfly Gamma Doppler Phase 4", item = "weapon_bf_gdp4", amount = 1, rarity = "Epic", image = "WEAPON_BF_GDP4.png"},
            
            -- Legendary Knives (3% chance total) - Ultra rare gem finishes (Ruby, Sapphire, Emerald, Black Pearl)
            {name = "Karambit Doppler BlackPearl", item = "weapon_karambit_dopplerblackpearl", amount = 1, rarity = "Legendary", image = "WEAPON_KARAMBIT_DOPPLERBLACKPEARL.png"},
            ...
            {name = "Butterfly Gamma Doppler Emerald", item = "weapon_bf_gdemerald", amount = 1, rarity = "Legendary", image = "WEAPON_BF_GDEMERALD.png"},
        }
    }
}
