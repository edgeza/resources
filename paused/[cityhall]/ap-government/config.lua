Config = {
	...
	VotingLaws = false, -- Set this to true if you want to use the law voting system.
	Phone = {GKSPhone = true, QBPhone = true, QuasarPhone = false, QSPRO = false, HighPhone = false, LBPhone = false, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
	...
	['qb-target'] = {
		...
		['appointmentsPed'] = {
			...
			['ped'] = {
				active = false,
				ped = {model = "a_m_m_prolhost_01"},
				coords = vector4(-566.0, -196.48, 17.63, 289.24),
				minusOne = true,
				freeze = true,
				invincible = true,
				blockevents = true
	...
	['DrawText'] = { -- Preset for Gabz Townhall
	  ['govpoints'] = {
		...
		['appointments'] = {
			...
			pos = {x = -566.0, y = -196.48, z = 17.63, length = 3.2, width = 4, boxName = "mayorappointments"}, 
