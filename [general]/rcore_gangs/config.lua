...
Config.ZoneOptions = {
    ...
    presenceTime = 60, -- The time in minutes that a gang member must be present in a zone to gain loyalty
    ...
    rivalryCost = 250000, -- The minimum amount of money needed to start a rivalry in a zone
    rivalryDuration = 24, -- The duration of rivalry in hours
}

Config.GangOptions = {
    garage = false, -- Enable garage checkpoint in gang menu
    storage = false, -- Enable storage checkpoint in gang menu
    reserve = false, -- Enable reserve checkpoint in gang menu
    ...
    kidnapping = false, -- Enable kidnapping feature from actions in gang menu

    zipTie = false, -- Optional ziptie item used when kidnapping is enabled
    paperBag = false, -- Optional paper bag item used when kidnapping is enabled

    maxMembers = 15, -- Maximum number of players in a gang
...
Config.OtherOptions = {
    ...
    dirtyMoneyAccountName = "markedbills", -- account name for the black money
    ...
    dirtyMoneyItem = true, -- Are you using dirty money as item?
    dirtyMoneyItemName = "markedbills", -- Item name for the black money
...
Config.Businesses = {
    ...
    ['ATOM_UP'] = {
        name = 'ATOM_UP',
        label = 'Atom, Downtown Vinewood',
        banner = 'shopui_title_atom',
        zone = 'DTVINE',
        hourlyIncome = 1000,
        checkpoint = vec3(77.39, 274.19, 110.21)
    },
    ['247_DTVINE'] = {
        name = '247_DTVINE',
        ...
        zone = 'DTVINE',
        hourlyIncome = 1000,
        checkpoint = vec3(381.78, 320.97, 103.33)
    },
    ['TATTOO_DTVINE'] = {
        name = 'TATTOO_DTVINE',
        ...
        zone = 'DTVINE',
        hourlyIncome = 1000,
        checkpoint = vec3(317.31, 177.8, 103.69)
    },
    ...
    ['LTD_KOREAT'] = {
        ...
        zone = 'KOREAT',
        hourlyIncome = 1000,
        checkpoint = vec3(-702.88, -918.24, 19.01)
    },
    ['AMMO_KOREAT'] = {
        name = 'AMMO_KOREAT',
        ...
        zone = 'KOREAT',
        hourlyIncome = 1000,
        checkpoint = vec3(-661.3, -945.52, 21.7)
    },
    ['CATCAFE'] = {
        name = 'CATCAFE',
        label = 'catcafe, Little Seoul',
        banner = 'shopui_title_catcafe',
        zone = 'KOREAT',
        hourlyIncome = 1000,
        checkpoint = vec3(-577.62, -1072.42, 22.33)
    },
    ...
    ['247_STRAW'] = {
        ...
        zone = 'STRAW',
        hourlyIncome = 1000,
        checkpoint = vec3(35.74, -1350.88, 29.31)
    },
    ['SECOND_HAND_STRAW'] = {
        ...
        zone = 'STRAW',
        hourlyIncome = 1000,
        checkpoint = vec3(84.05, -1399.31, 29.42)
    },
    ...
    ['247_SANDY'] = {
        ...
        zone = 'SANDY',
        hourlyIncome = 1000,
        checkpoint = vec3(1963.11, 3736.81, 32.37)
    },
    ['AMMO_SANDY'] = {
        name = 'AMMO_SANDY',
        ...
        zone = 'SANDY',
        hourlyIncome = 1000,
        checkpoint = vec3(1698.68, 3749.07, 34.38)
    },
    ['BARBER_SANDY'] = {
        name = 'BARBER_SANDY',
        ...
        zone = 'SANDY',
        hourlyIncome = 1000,
        checkpoint = vec3(1931.2, 3720.96, 32.84)
    },
    ['TATTOO_SANDY'] = {
        name = 'TATTOO_SANDY',
        ...
        zone = 'SANDY',
        hourlyIncome = 1000,
        checkpoint = vec3(1857.9, 3750.52, 33.07)
    },
    ...
    ['TATTOO_SANDY2'] = {
        name = 'TATTOO_SANDY2',
        label = 'Shop, Sandy Shores',
        banner = 'shopui_title_drugs',
        zone = 'SANDY',
        hourlyIncome = 1000,
        checkpoint = vec3(1391.86, 3596.88, 35.05)
    },
    ...
    ['AMMO_PALETO'] = {
        ...
        zone = 'PALETO',
        hourlyIncome = 1000,
        checkpoint = vec3(-326.22, 6073.2, 31.23)
    },
    ['SECOND_HAND_PALETO'] = {
        ...
        zone = 'ELGORL',
        hourlyIncome = 1000,
        checkpoint = vec3(-4.78, 6515.15, 31.48)
    },
    ['BARBER_PALETO'] = {
        name = 'BARBER_PALETO',
        ...
        zone = 'PALETO',
        hourlyIncome = 1000,
        checkpoint = vec3(-286.46, 6231.1, 31.49)
    },
    ...
    ['LTD_DAVIS'] = {
        ...
        zone = 'DAVIS',
        hourlyIncome = 1000,
        checkpoint = vec3(-48.61, -1761.65, 29.44)
    },
    ['RON_DAVIS'] = {
        name = 'RON_DAVIS',
        label = 'Ron, Davis',
    ...
    ['BARBER_DAVIS'] = {
        ...
        zone = 'DAVIS',
        hourlyIncome = 1000,
        checkpoint = vec3(129.85, -1712.14, 29.27)
    },
    ...
    ['LTD_MIRR'] = {
        ...
        zone = 'MIRR',
        hourlyIncome = 1000,
        checkpoint = vec3(1154.95, -329.3, 69.05)
    },
    ['ONELIFE_MECH'] = {
        name = 'ONELIFE_MECH',
        label = 'OneLife Mech, Mirror Park',
        banner = 'shopui_title_mechshop',
        zone = 'MIRR',
        hourlyIncome = 1000,
        checkpoint = vec3(1127.16, -775.57, 57.62)
    },
    ['BARBER_MIRR'] = {
        name = 'BARBER_MIRR',
        ...
        zone = 'MIRR',
        hourlyIncome = 1000,
        checkpoint = vec3(1203.68, -473.81, 66.16)
    },
    ...
    ['LTD_GRAPES'] = {
        ...
        zone = 'GRAPES',
        hourlyIncome = 1000,
        checkpoint = vec3(1700.43, 4934.53, 42.08)
    },
    ['SECOND_HAND_GRAPES'] = {
        ...
        zone = 'GRAPES',
        hourlyIncome = 1000,
        checkpoint = vec3(1684.64, 4825.7, 42.01)
    },
    ...
    ['RON_MORN'] = {
        ...
        zone = 'MORN',
        hourlyIncome = 1000,
        checkpoint = vec3(-1436.61, -260.15, 46.26)
    },
    ['ROB_LIQUOR_MORN'] = {
        ...
        zone = 'MORN',
        hourlyIncome = 1000,
        checkpoint = vec3(-1488.11, -389.34, 39.31)
    },
    ['AMMO_MORN'] = {
        name = 'AMMO_MORN',
        ...
        zone = 'MORN',
        hourlyIncome = 1000,
        checkpoint = vec3(-1316.87, -393.97, 36.6)
    },
    ['PONSON_MORN'] = {
        name = 'PONSON_MORN',
        ...
        zone = 'MORN',
        hourlyIncome = 1000,
        checkpoint = vec3(-1453.42, -226.96, 49.15)
    },
    ...
    ['AMMO_LMESA'] = {
        ...
        zone = 'LMESA',
        hourlyIncome = 1000,
        checkpoint = vec3(846.93, -1020.17, 27.53)
    },
    ...
    ['TATTOO_EBURO'] = {
        ...
        zone = 'EBURO',
        hourlyIncome = 1000,
        checkpoint = vec3(1317.97, -1651.65, 52.15)
    },
    ...
    ['ROB_LIQUOR_VCANA'] = {
        ...
        zone = 'VCANA',
        hourlyIncome = 1000,
        checkpoint = vec3(-1230.94, -903.66, 12.13)
    },
    ['BINCO_VCANA'] = {
        name = 'BINCO_VCANA',
        ...
        zone = 'VCANA',
        hourlyIncome = 1000,
        checkpoint = vec3(-822.98, -1083.97, 11.13)
    },
    ['TATTOO_VCANA'] = {
        name = 'TATTOO_VCANA',
        ...
        zone = 'VCANA',
        hourlyIncome = 1000,
        checkpoint = vec3(-1152.83, -1420.54, 4.85)
    },
    ['BURGERSHOT'] = {
        name = 'TATTOO_VCANA',
        label = 'Burgershot, Vespucci Canals',
        banner = 'shopui_title_burgershot',
        zone = 'VCANA',
        hourlyIncome = 1000,
        checkpoint = vec3(-1183.72, -879.34, 13.81)
    },
    ...
    ['AMMO_HAWICK'] = {
        ...
        zone = 'HAWICK',
        hourlyIncome = 1000,
        checkpoint = vec3(241.28, -49.35, 69.9)
    },
    ['BARBER_HAWICK'] = {
        name = 'BARBER_HAWICK',
        ...
        zone = 'HAWICK',
        hourlyIncome = 1000,
        checkpoint = vec3(-35.04, -143.1, 57.14)
    },
    ...
    ['AMMO_PBOX'] = {
        ...
        zone = 'PBOX',
        hourlyIncome = 1000,
        checkpoint = vec3(12.2, -1115.75, 28.88)
    },
    ['BEAN_MACHINE'] = {
        name = 'BEAN_MACHINE',
        label = 'Bean Machine, Mission Row',
        banner = 'shopui_title_beanmachine',
        zone = 'PBOX',
        hourlyIncome = 1000,
        checkpoint = vec3(110.5, -1042.9, 29.33)
    },
    ...
    ['AMMO_CYPRE'] = {
        ...
        zone = 'CYPRE',
        hourlyIncome = 1000,
        checkpoint = vec3(815.44, -2146.82, 29.39)
    },
    ['EAST_CUSTOMS'] = {
        name = 'EAST_CUSTOMS',
        label = 'East Customs, Cypress Flats',
        banner = 'shopui_title_mechshop',
        zone = 'CYPRE',
        hourlyIncome = 1000,
        checkpoint = vec3(867.84, -2118.85, 30.51)
    },
    ...
    ['SUBURBAN_ALTA'] = {
        ...
        zone = 'ALTA',
        hourlyIncome = 1500,
        checkpoint = vec3(123.27, -204.21, 54.58)
    },
    ...
    ['SUBURBAN_MOVIE'] = {
        ...
        zone = 'MOVIE',
        hourlyIncome = 1500,
        checkpoint = vec3(-1207.65, -776.5, 17.34)
    },
    ...
    ['GYM_ROCKF'] = {
        name = 'GYM_ROCKF',
        label = 'Gym, Rockford Hills',
        banner = 'shopui_title_gym',
        zone = 'ROCKF',
        hourlyIncome = 1000,
        checkpoint = vec3(-758.77, 238.21, 75.67)
    },
    ['PONSON_ROCKF'] = {
        name = 'PONSON_ROCKF',
        ...
        zone = 'ROCKF',
        hourlyIncome = 1000,
        checkpoint = vec3(-720.72, -152.39, 37.02)
    },
    ['BARBER_ROCKF'] = {
        name = 'BARBER_ROCKF',
        ...
        zone = 'ROCKF',
        hourlyIncome = 1000,
        checkpoint = vec3(-822.18, -192.33, 37.59)
    },
    ...
    ['PONSON_BURTON'] = {
        ...
        zone = 'BURTON',
        hourlyIncome = 1500,
        checkpoint = vec3(-152.94, -298.9, 39.54)
    },
    ...
    ['BINCO_TEXTI'] = {
        ...
        zone = 'TEXTI',
        hourlyIncome = 1500,
        checkpoint = vec3(417.38, -810.21, 29.34)
    },
    ...
    ['BARBER_VESP'] = {
        ...
        zone = 'VESP',
        hourlyIncome = 1000,
        checkpoint = vec3(-1291.3, -1114.21, 6.72)
    },
    ['BEACH_GYM'] = {
        name = 'BEACH_GYM',
        label = 'Beachcombover Gym, Vespucci',
        banner = 'shopui_title_barber',
        zone = 'VESP',
        hourlyIncome = 1000,
        checkpoint = vec3(-1198.98, -1580.31, 4.61)
    },
    ...
    ['COMIC_SHOP'] = {
        name = 'COMIC_SHOP',
        label = 'Los Santos Comics, West VineWood',
        banner = 'shopui_title_comicshop',
        zone = 'WVINE',
        hourlyIncome = 1500,
        checkpoint = vec3(-147.85, 231.38, 94.94)
    },
    ...
    ['CHIL_FASHION'] = {
        name = 'CHIL_FASHION',
        label = 'Fashion, Great Ocean',
        banner = 'shopui_title_chil1',
        zone = 'CHIL',
        hourlyIncome = 1000,
        checkpoint = vec3(-3161.64, 1059.0, 20.84)
    },
    ['CHIL_TATTOO'] = {
        name = 'CHIL_TATTOO',
        label = 'Tattoo, Great Ocean',
        banner = 'shopui_title_chil2',
        zone = 'CHIL',
        hourlyIncome = 1000,
        checkpoint = vec3(-3164.92, 1076.8, 20.85)
    },
    ['CHIL_STORE'] = {
        name = 'CHIL_STORE',
        label = 'Tattoo, Great Ocean',
        banner = 'shopui_title_chil3',
        zone = 'CHIL',
        hourlyIncome = 1000,
        checkpoint = vec3(-3238.08, 1001.85, 12.51)
    },    
    ['CHIL_AMMO'] = {
        name = 'CHIL_AMMO',
        label = 'Ammo, Great Ocean',
        banner = 'shopui_title_chil4',
        zone = 'CHIL',
        hourlyIncome = 1000,
        checkpoint = vec3(-3161.33, 1085.18, 20.85)
    },
    ...
    ['PROCOB_STORE'] = {
        name = 'PROCOB_STORE',
        label = 'Store, Great Ocean',
        banner = 'shopui_title_storeocean',
        zone = 'PROCOB',
        hourlyIncome = 1500,
        checkpoint = vec3(-3038.45, 594.16, 7.82)
    },
    ...
    ['GREATC_GAS'] = {
        name = 'GREATC_GAS',
        label = 'Gas Station',
        banner = 'shopui_title_northgas',
        zone = 'GREATC',
        hourlyIncome = 1500,
        checkpoint = vec3(-1817.33, 789.08, 137.95)
    },
    ...
    ['RGLEN_GAS'] = {
        name = 'RGLEN_GAS',
        label = 'Gas Station',
        banner = 'shopui_title_westgas',
        zone = 'RGLEN',
        hourlyIncome = 1500,
        checkpoint = vec3(-2073.44, -318.94, 13.32)
    },
    ...
    ['LAGO_GAS'] = {
        name = 'LAGO_GAS',
        label = 'Gas Station',
        banner = 'shopui_title_lago1',
        zone = 'LAGO',
        hourlyIncome = 1000,
        checkpoint = vec3(-341.17, -1479.04, 30.75)
    },
    ['LAGO_AVIATION'] = {
        name = 'LAGO_GAS',
        label = 'Aviation Station',
        banner = 'shopui_title_lago2',
        zone = 'LAGO',
        hourlyIncome = 1000,
        checkpoint = vec3(-723.55, -1496.53, 5.0)
    },
    ['LAGO_BILLIARDS'] = {
        name = 'LAGO_GAS',
        label = 'Billiards',
        banner = 'shopui_title_lago3',
        zone = 'LAGO',
        hourlyIncome = 1000,
        checkpoint = vec3(-1159.79, -1618.6, 4.37)
    },
    ...
    ['AIRP_SHOP1'] = {
        ...
        banner = 'shopui_title_ben1',
        zone = 'AIRP',
        hourlyIncome = 1000,
        checkpoint = vec3(-906.29, -2036.05, 9.41)
    },
    ['AIRP_SHOP2'] = {
        name = 'AIRP_SHOP2',
        label = 'Bennys Race Track',
        banner = 'shopui_title_ben2',
        zone = 'AIRP',
        hourlyIncome = 1000,
        checkpoint = vec3(-769.9, -2060.06, 9.02)
    },
    ...
    ['LACT_SHOP1'] = {
        name = 'LACT_SHOP1',
        label = 'Heli Station',
        banner = 'shopui_title_lact1',
        zone = 'LACT',
        hourlyIncome = 1000,
        checkpoint = vec3(-1161.44, -2890.79, 13.95)
    },
    ['LACT_SHOP2'] = {
        name = 'LACT_SHOP2',
        label = 'Plane Station',
        banner = 'shopui_title_lact2',
        zone = 'LACT',
        hourlyIncome = 1000,
        checkpoint = vec3(-1253.13, -2311.54, 13.94)
    },
    ...
    ['OBSERV_SHOP1'] = {
        name = 'OBSERV_SHOP1',
        label = 'Shop Grocery',
        banner = 'shopui_title_observ1',
        zone = 'OBSERV',
        hourlyIncome = 1000,
        checkpoint = vec3(546.59, 2675.45, 42.17)
    },
    ['OBSERV_SHOP2'] = {
        name = 'OBSERV_SHOP2',
        label = 'Clothing Store',
        banner = 'shopui_title_observ2',
        zone = 'OBSERV',
        hourlyIncome = 1000,
        checkpoint = vec3(613.68, 2744.71, 41.97)
    },
    ['OBSERV_SHOP3'] = {
        name = 'OBSERV_SHOP3',
        label = 'Gas Station',
        banner = 'shopui_title_observ3',
        zone = 'OBSERV',
        hourlyIncome = 1000,
        checkpoint = vec3(252.36, 2597.95, 44.84)
    },
    ['OBSERV_SHOP4'] = {
        name = 'OBSERV_SHOP4',
        label = 'Fuel Station',
        ...
        zone = 'OBSERV',
        hourlyIncome = 1000,
        checkpoint = vec3(42.65, 2789.61, 57.9)
    },
    ...
    ['OCEANA_SHOP1'] = {
        name = 'OCEANA_SHOP1',
        label = 'Shop Grocery2',
        banner = 'shopui_title_oceana1',
        zone = 'OCEANA',
        hourlyIncome = 1000,
        checkpoint = vec3(1050.09, 2664.15, 39.55)
    },
    ['OCEANA_SHOP2'] = {
        name = 'OCEANA_SHOP2',
        label = 'Clothing Store3',
        banner = 'shopui_title_oceana2',
        zone = 'OCEANA',
        hourlyIncome = 1000,
        checkpoint = vec3(1168.62, 2701.86, 38.18)
    },
    ['OCEANA_SHOP3'] = {
        name = 'OBSERV_SHOP3',
        label = 'Gas Station4',
        banner = 'shopui_title_oceana3',
        zone = 'OCEANA',
        hourlyIncome = 1000,
        checkpoint = vec3(1199.86, 2702.04, 38.15)
    },
    ['OCEANA_SHOP4'] = {
        name = 'OBSERV_SHOP4',
        label = 'Gas Station4',
        banner = 'shopui_title_oceana4',
        zone = 'OCEANA',
        hourlyIncome = 1000,
        checkpoint = vec3(1206.56, 2652.79, 37.85)
    },
    ['PALCOV_FUEL'] = {
        name = 'PALCOV_FUEL',
        label = 'Sandy Gas Station6',
        banner = 'shopui_title_palcov',
        zone = 'PALCOV',
        hourlyIncome = 1000,
        checkpoint = vec3(2675.01, 3266.81, 55.24)
    },
    ['PBLUFF_TUNER'] = {
        name = 'PBLUFF_TUNER',
        label = '6str Tuner Shop',
        banner = 'shopui_title_tuner',
        zone = 'PBLUFF',
        hourlyIncome = 1000,
        checkpoint = vec3(157.28, -3043.85, 7.03)
    },
    ['CMSW_FUEL'] = {
        name = 'CMSW_FUEL',
        label = 'Sandy Gas Station7',
        banner = 'shopui_title_cmsw',
        zone = 'CMSW',
        hourlyIncome = 1000,
        checkpoint = vec3(1775.84, 3233.91, 42.37)
    },
    ['GALFISH_SHOP'] = {
        name = 'GALFISH_SHOP',
        label = 'Logistics Trucking',
        banner = 'shopui_title_galfish',
        zone = 'GALFISH',
        hourlyIncome = 1500,
        checkpoint = vec3(1214.31, -3105.52, 6.03)
    },
    ['CCREAK_CASINO'] = {
        name = 'CCREAK_CASINO',
        ...
        zone = 'CCREAK',
        hourlyIncome = 1500,
        checkpoint = vec3(919.27, 40.61, 81.1)
    },
}
...
Config.GangZones['CHIL'] = {
    name = 'CHIL',
    label = 'Great Ocean Mall',
    neighbors = {
        'DELBE'
    },
    parts = {
        { x1 = -2854.42, y1 = 878.96, x2 = -3423.02, y2 = 1465.854 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['PROCOB'] = {
    ...
    parts = {
        { x1 = -3362.69, y1 = -20.42, x2 = -2854.42, y2 = 878.96 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['RGLEN'] = {
    name = 'RGLEN',
    label = 'West Eclipse Boulevard',
    neighbors = {
        'MORN'
    },
    parts = {
        { x1 = -1635.47, y1 = -500.0, x2 = -2138.031, y2 = -111.890 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['GREATC'] = {
    name = 'GREATC',
    label = 'North Rockford Hills',
    neighbors = {
        'RGLEN',
        'MORN',
        'ROCKF'
    ...
    parts = {
        { x1 = -2138.031, y1 = -111.890, x2 = -1299.928, y2 = 890.207 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['LAGO'] = {
    ...
    parts = {
        { x1 = -286.8, y1 = -1427.012, x2 =  -1180.78, y2 = -1785.768 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['AIRP'] = {
    name = 'AIRP',
    label = 'Air Port Entrance',
    neighbors = {
        'LAGO'
    },
    parts = {
        { x1 = -1180.78, y1 = -1785.768, x2 =  -139.2, y2 =  -2246.03 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['LACT'] = {
    ...
    parts = {
        { x1 = -852.024, y1 =  -2245.610, x2 =  -1577.437, y2 =  -2969.512 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['OBSERV'] = {
    ...
    parts = {
        { x1 = 837.657, y1 =   3058.81, x2 =  -2.413, y2 =  2572.561 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['OCEANA'] = {
    ...
    parts = {
        { x1 = 837.657, y1 =   3058.81, x2 =  1403.234, y2 =  2572.561 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['SANDY'] = {
    ...
    parts = {
        { x1 = 1295.66, y1 = 3888.02, x2 = 2145.09, y2 = 3554.05 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['CMSW'] = {
    ...
    parts = {
        { x1 = 2145.09, y1 = 3554.05, x2 = 1295.66, y2 = 3058.81 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['PALCOV'] = {
    name = 'PALCOV',
    label = 'Sandy High Way',
    neighbors = {
        'SANDY',
        'CMSW'
    },
    parts = {
        { x1 = 2145.09, y1 = 3058.81, x2 = 2736.486, y2 = 3888.02 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['PBLUFF'] = {
    ...
    parts = {
        { x1 =  293.195, y1 = -3340.549, x2 = 115.227, y2 =  -2831.402 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['GALFISH'] = {
    ...
    parts = {
        { x1 =  1287.102, y1 = -3357.317, x2 = 682.312, y2 =  -2935.061 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
...
Config.GangZones['CCREAK'] = {
    name = 'CCREAK',
    label = 'Casino Vinewood',
    neighbors = {
        'EAST_V',
        'DTVINE'
    },
    parts = {
        { x1 = 1391.0, y1 = -35.97, x2 = 695.87, y2 = 445.02 },
    },
    drugPreference = {
        CATEGORY_LOW = 1.0,
        CATEGORY_MED = 1.0,
