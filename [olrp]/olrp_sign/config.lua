...
Config.Framework = 'autodetect' -- esx, qbcore, qbox, standalone or autodetect

Config.Command = 'olrpsign' -- Command to open the menu

Config.AuthorizedGroups = {
    group = { -- Only for esx, qbcore, and qbox
        'admin'
    },
