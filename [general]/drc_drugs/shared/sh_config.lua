...
Config.Dispatch = { enabled = true, script = "ps-dispatch" } -- ps-dispatch, linden_outlawalert, ps-disptach
...
Config.DirtyMoney = true -- Money for selling
...
Config.Madrazo = {
    ...
    RequiredItems = {
        { item = "coke_figure", count = 15, remove = true },
    },
    AddItems = {
    ...
    Log = "Has Traded 15x coke figure for 1 Meth Access Card"
}
...
Config.LocateDealer = {
    enabled = true,
    RequiredItems = {
        { item = "trojan_usb", count = 1, remove = true }, -- Add you hacking usb item from your server or just create one!
    },
...
Config.Pharmacist = {
    ...
    Items = {
        { label = 'Empty Plastic Can', item = 'meth_emptysacid', description = "Buy Empty Plastic Can for: $",
            price = 1000, MinAmount = 1, MaxAmount = 100 },
        { label = 'Amonian', item = 'meth_amoniak', description = "Buy Amoniak for: $", price = 80, MinAmount = 1,
            MaxAmount = 100 },
        { label = 'Syringe', item = 'syringe', description = "Buy Syringe for: $", price = 40, MinAmount = 1,
            MaxAmount = 100 },
        { label = 'Meth Pipe', item = 'meth_pipe', description = "Buy Meth Pipe for: $", price = 60, MinAmount = 1,
            MaxAmount = 100 },
        { label = 'Crack Pipe', item = 'crack_pipe', description = "Buy Crack Pipe for: $", price = 60, MinAmount = 1,
            MaxAmount = 100 },
    },
...
Config.Dealer = {
    ...
    Items = {
        ...
        { label = 'Blunt Wraps', item = 'weed_wrap', description = "Buy Blunt wraps for: $", price = 200, MinAmount = 1,
            MaxAmount = 100 },
        { label = 'Plastic Bag', item = 'plastic_bag', description = "Buy Plastic Bag for: $", price = 60, MinAmount = 1,
            MaxAmount = 100 },
    },
    Ped = {
...
Config.ComicShop = {
    ...
    Header = "Comic Shop",
    Items = {
        { label = 'Action Figure', item = 'coke_figureempty', description = "Buy Action Figure for: $", price = 180,
...
Config.Weed = {
    ...
    --ENTER LAB
    Enterlab = {
        coords = vec3(2221.98, 5614.72, 54.9),
        radius = 1.2,
    ...
    --LEAVE LAB
    LeaveLab = {
        coords = vector3(1066.57, -3183.46, -38.96), radius = 1.0, teleport = vec3(2221.98, 5614.72, 54.9),
    },
    --Collecting weed
    Pickup = {
    ...
    Package = {
        ...
        Log = "Has proccessed 5x Weed bud, 1x Plastic bag into 5x Weed Packed"
    },
}
...
Config.Meth = {
    ...
    --ENTER LAB
    Enterlab = {
        coords = vec3(-1416.48, -875.19, 15.96),
        radius = 1.6,
    ...
    LeaveLab = {
        ...
        radius = 1.0,
        teleport = vec3(-1416.48, -875.19, 15.96),
    },
    --GET ACID
    GetSacid = {
        coords = vector3(813.64, -1585.98, 31.68),
        radius = 1.0,
        teleport = vector3(813.64, -1585.98, 31.68),
        RequiredItems = {
            { item = "meth_emptysacid", count = 4, remove = true },
        },
        AddItems = {
            { item = "meth_sacid", count = 4 },
        },
    ...
    Pouring = {
        ...
        description = "Ingredients: 2x Amoniak, 1x Sodium benzoate",
    ...
    Complete = {
        ...
        Log = "Has proccessed 1x Amoniak, 1x Sodium benzoate into 1x Meth tray's"
    },
    --Break
    Break = {
        header = "Break Meth",
        ...
        Log = "Has proccessed 1x Meth tray, 1x Hammer into 1x Broken Meth shards"
    },
    --Package
    Package = {
        header = "Pack Meth",
        ...
        AddItems = {
            { item = "meth_bag", count = 20 },
        },
        Log = "Has proccessed 1x Broken Meth tray, 1x Plastic bag into 20x Meth baggies"
...
Config.Heroin = {
    --Field
    Field = {
        coords = vector3(-103.79, -427.62, 36.18),
        radius = 18.00,
        Duration = 5000,
        name = "PoppyField",
        debugPoly = false,
        ...
        Log = "Has picked up 3x Poppy Plant"
    },
    --Process
    Process = {
        header = "Process Poppy plants",
        description = "Ingredients: 5x Poppy plant, 1x Amoniak, 1x Plastic bag",
        coords = vector3(164.64, -1187.52, 30.8),
        radius = 0.4,
        Teleport = vector3(164.64, -1187.52, 30.8),
        Duration = 5000,
        RequiredItems = {
...
Config.Crack = {
    ...
    Process = {
        header = "Make Crack",
        description = "Ingredients: 5x Pure Coke, 5x Baking Soda, 5X Water Bottle",
        coords = vec3(168.37, -1299.18, 29.37),
        radius = 0.4,
        Teleport = vector3(548.51, -191.77, 54.48),
        Duration = 20000,
        RequiredItems = {
            { item = "coke_pure", count = 5, remove = true },
            { item = "baking_soda", count = 5, remove = true },
            { item = "water_bottle", count = 5, remove = true },
        },
        AddItems = {
            { item = "crack", count = 5 },
        },
        Log = "Has proccessed 5x Pure Coke, 5x Baking Soda, 5X Water Bottle into 5X Crack"
    },
}
...
Config.Coke = {
    ...
    --ENTER LAB
    Enterlab = {
        coords = vec3(-324.83, 6286.77, 32.88),
        radius = 1.2,
    ...
    LeaveLab = {
        ...
        radius = 0.8,
        teleport = vec3(-324.83, 6286.77, 32.88),
    },
    --Field
    Field = {
        coords = vector3(-455.79, -1155.72, 24.58),
        radius = 25.0,
        DebugPoly = false,
        name = "Cokefield",
    ...
    LeafProcess = {
        ...
        description = "Ingredients: 5x Coke Leaves", coords = vector3(1101.8, -3193.06, -38.98), radius = 0.4,
        boxcoords = vector4(1101.81, -3193.14, -39.18, 90),
        Duration = 2000,
        RequiredItems = {
            { item = "coke_leaf", count = 5, remove = true },
        },
        AddItems = {
            { item = "coke_box", count = 1 },
        },
        Log = "Has proccessed 5x Coke Leaves into 1x Coke Box"
    },
    --CokeBox
    CokeBox = {
        header = "Pour Coke",
        ...
        heading = 0.0,
        ForceDurationClient = 20000,
        RequiredItems = {
            { item = "coke_box", count = 1, remove = true },
        },
        AddItems = {
            { item = "coke_raw", count = 20 },
        },
        Log = "Has proccessed 1x Coke Box into 20x Raw Coke"
    },
    --Coke Cleaning
    Soda = {
        header = "Clean Coke",
        description = "Ingredients: 20x Raw Coke",
        RequiredItems = {
            { item = "coke_raw", count = 20, remove = true },
        },
        AddItems = {
            { item = "coke_pure", count = 20 },
        },
        Log = "Has proccessed 20x Raw Coke into 20x Pure Coke"
    },
    SodaTables = {
...
Config.Drugs = {
    ...
    meth_bag = { -- Item name
        ...
        ReqPolice = 3, -- Police count
        ReportChance = 100, --Dispatch Chance 0 - 100 %
        MinPrice = 800, -- Min price
        MaxPrice = 1200, -- Max price
        MinCount = 2, -- Min Count
        MaxCount = 4, -- Max Count
        Chance = 15, -- 0 - 100% succes of negotiate for better price
        AttackChance = 50, -- 0 - 100% Chance of NPC atacking player
        animation = {
